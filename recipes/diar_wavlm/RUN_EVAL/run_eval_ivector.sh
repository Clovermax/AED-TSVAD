...
eval_set_dir=("DATA_AMI" "DATA_ALIMEETING" "DATA_AISHELL4" "DATA_NOTSOFAR-SC" "DATA_MSDWILD" "DATA_RAMC" "DATA_DIHARD2" "DATA_DIHARD3" "DATA_CHIME6" "DATA_VOXCONVERSE")
...
eval_set_dir_str=$(IFS=,; echo "${eval_set_dir[*]}")
